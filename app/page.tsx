...
const COMPLIMENTS = [
  "У тебя блестящий ум и доброе сердце.",
  "Твой смех заразителен и приносит радость всем вокруг.",
  "У тебя невероятный дар заставлять людей чувствовать себя услышанными.",
  "Твоя креативность не знает границ.",
  "Ты справляешься с трудностями с невероятной грацией.",
  "Твоя дружба — это подарок, который я ценю каждый день.",
  "У тебя безупречный вкус.",
  "Мир становится лучше, когда ты в нем есть.",
  "Ты способна на удивительные вещи.",
